                    ...
                    <div class="col-auto">
                        <ul class="border-list">
                            <li>
                                <div class="dropdown">
                                    <a class="dropdown-toggle" href="javascript:void(0)" role="button"
                                        ...
                                        <span><strong>Login</strong> & Register</span>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink">
                                        ...
                                        <li class="w-100">
                                            <a class="dropdown-item" href="sign-up.html">Ragistore</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="dropdown top-header-dropdown">
                                    <a class="dropdown-toggle" href="javascript:void(0)" role="button"
                                        ...
                                        <span><b>$</b> Dollar</span>
                                        <i class="fas fa-chevron-down"></i>
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink">
                                        <li class="w-100">
                                            <a class="dropdown-item" id="dollar" href="javascript:void(0)">$ Dollar</a>
                                        </li>

                                        <li class="w-100">
                                            <a class="dropdown-item" id="rupee" href="javascript:void(0)">₹ Rupee</a>
                                        </li>

                                        <li class="w-100">
                                            <a class="dropdown-item" id="euro" href="javascript:void(0)">€ Euro</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="dropdown top-header-dropdown">
                                    <a class="dropdown-toggle" href="javascript:void(0)" role="button"
                                        id="dropdownMenuLink2" data-bs-toggle="dropdown"><span>Language</span>
                                        <i class="fas fa-chevron-down"></i>
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink">
                                        <li class="w-100">
                                            <a class="dropdown-item" id="english" href="javascript:void(0)">English</a>
                                        </li>

                                        <li class="w-100">
                                            <a class="dropdown-item" id="french" href="javascript:void(0)">French</a>
                                        </li>

                                        <li class="w-100">
                                            <a class="dropdown-item" id="arabic" href="javascript:void(0)">Arabic</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
