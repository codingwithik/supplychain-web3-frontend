...
<html lang="en">
    ...
    <head>
        ...
        <!-- App css -->
        <link href="assets-admin/css/bootstrap-dark.min.css" id="bootstrap-dark" rel="stylesheet" type="text/css" />
        <link href="assets-admin/css/bootstrap.min.css" id="bootstrap-light" rel="stylesheet" type="text/css" />
        <link href="assets-admin/css/icons.min.css" rel="stylesheet" type="text/css" />
        <link href="assets-admin/css/app-rtl.min.css" id="app-rtl" rel="stylesheet" type="text/css" />
        <link href="assets-admin/css/app-dark.min.css" id="app-dark" rel="stylesheet" type="text/css" />
        <link href="assets-admin/css/app.min.css" id="app-light" rel="stylesheet" type="text/css" />
    </head>
    ...
    <body>
        ...
        <script src="assets-admin/libs/bootstrap/bootstrap.min.js"></script>
        ...
        <script src="assets-admin/libs/node-waves/node-waves.min.js"></script>
